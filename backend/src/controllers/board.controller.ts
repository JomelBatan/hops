...
export async function createBoard(req: Request, res: Response) {
  try {
    ...
    res
      .status(500)
      .json({ error: "Erorr on Board Controller: [Create Board Function]" });
  }
}
...
export async function updateBoard(req: Request, res: Response) {
  try {
    ...
    res
      .status(500)
      .json({ error: "Error on Board Controller: [Update Board Function]" });
  }
}
export async function deleteBoard(req: Request, res: Response) {
  try {
    ...
    res
      .status(500)
      .json({ error: "Error on Board Controller: [Delete Board Function]" });
  }
}
export async function getActivity(req: Request, res: Response) {
  try {
    ...
    res
      .status(500)
      .json({ error: "Error on Board Controller: [Get Activity Function]" });
  }
}
export async function addMember(req: Request, res: Response) {
  try {
    ...
    res
      .status(500)
      .json({ error: "Error on Board Controller: [Add Member Function]" });
  }
}
export async function removeMember(req: Request, res: Response) {
  try {
    ...
    res
      .status(500)
      .json({ error: "Error on Board Controller: [Remove Member Function]" });
  }
}
